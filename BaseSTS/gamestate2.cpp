...
void gamestate::makeRelicDatabase()
{
    ...
    relic_database.emplace("MembershipCard_ID", make_unique<membershipCard>());//
    ...
    relic_database.emplace("BlackStar_ID", make_unique<blackStar>());//
    relic_database.emplace("BustedCrown_ID", make_unique<bustedCrown>());
    relic_database.emplace("CallingBell_ID", make_unique<callingBell>());//
