...
enum class combatChoices {
    None, HandDW, HandAR, HandWC, HandTA, Hand, HandMulti3, HandMulti5, HandMultiAll, Exhaust, Discard,
...
int clamp(const int& value_, const int& lower_, const int& upper_);
float clamp(const float& value_, const float& lower_, const float& upper_);
